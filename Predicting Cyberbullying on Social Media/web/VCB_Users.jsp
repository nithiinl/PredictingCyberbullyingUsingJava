...
<div id="abstract">
    ...
    <td colspan="2"><image src="view.jsp?email=<%=email1%>" width="150" height="150"/></td>
              ...
              <tr><th>Post title</th><td><%=r.getString("title")%></td>
              </tr>
           ...
           ResultSet rd=rr.getExecuteQuery(s);
            while(rd.next()){
                ...
                String fil=rd.getString("filter");
                    ...
                    %>
              <tr><th>Cyber Bulling User</th><td style="color:red"  word-spacing="30px" ><%=comby%></td></tr>
 <tr><th>Cyber Comment</th><td style="color:red"><%=comm%></td></tr>
  <tr><th>Cyber Type</th><td style="color:red"><%=fil%></td></tr> 
  <tr><th><a href="BlockUser.jsp?user=<%=comby%>">Block User</a></th></tr> 
<%
    }
